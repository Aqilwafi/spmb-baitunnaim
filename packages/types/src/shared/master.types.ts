...
export type MasterCategories = Tables<'master_categories'>;
export type MasterCategoriesInsert = TablesInsert<'master_roles'>;
export type MasterCategoriesUpdate = TablesUpdate<'master_roles'>;