...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly gender_enum: readonly ["L", "P"];
            readonly hubungan_enum: readonly ["AYAH", "IBU", "WALI"];
            readonly pendidikan_keluarga_enum: readonly ["SD", "SMP", "SMA", "D3", "S1", "S2", "S3", "LAINNYA"];
            readonly semester_enum: readonly ["GANJIL", "GENAP"];
            readonly status_validasi_enum: readonly ["PENDING", "APPROVED", "REVISION_REQUIRED"];
        };
    };
};
export {};
