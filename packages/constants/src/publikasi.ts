...
// import { BlogCardProps2 } from "@/types/props";

// export const publikasi: BlogCardProps2[] = [
//   {
//     id: 1,
//     judul: "Panggung Kartini, Panggung Ekspresi Siswa MI Al Maarif Ngadri",
//     slug: "panggung-kartini-panggung-ekspresi-siswa-mi-al-maarif-ngadri",
...
//       "Acara ini menjadi ajang bagi siswa-siswi untuk menampilkan kreativitas mereka melalui berbagai produk hasil karya tangan, mulai dari makanan ringan hingga kerajinan tangan.",
//       "Selain sebagai bentuk perayaan, Market Day juga memberikan pengalaman berharga dalam berwirausaha, menggali potensi dan keterampilan bisnis para siswa-siswi.",
//       "Seluruh siswa-siswi dengan antusias mengisi stand mereka dengan berbagai barang dagangan yang mereka buat sendiri.",
//       "Kegiatan ini juga mengajarkan pentingnya bekerja keras, kolaborasi, dan jiwa kepemimpinan.",
//     ],
...
//       "Kegiatan seperti jalan sehat dan market day membawa pesan tentang kerja keras, sportivitas, dan pentingnya pendidikan dalam kehidupan.",
//       "Semangat yang terbangun diharapkan dapat terus menggugah para siswa-siswi untuk belajar, berinovasi, dan menjaga kebersamaan.",
//     ],
...
//       "Kegiatan ini menjadi bagian penting dalam mengevaluasi capaian belajar selama enam tahun terakhir.",
//       "Para siswa mengikuti asesmen dengan semangat dan kesiapan, didampingi guru-guru yang memberikan motivasi.",
//       "Semoga seluruh proses berjalan lancar dan hasilnya menjadi bekal terbaik menuju jenjang selanjutnya.",
//     ],
...
//       "Anak-anak terlihat antusias kembali bertemu teman-teman dan guru-guru mereka.",
//       "Kegiatan halal bihalal menghangatkan suasana sebagai sarana saling memaafkan dan berbagi cerita.",
//       "Melalui kegiatan ini, anak-anak diajarkan nilai persaudaraan, saling menghormati, dan menjaga hubungan baik sejak dini.",
//     ],
...
//       "Para siswa dan guru kembali masuk sekolah dengan semangat tinggi setelah libur panjang Idul Fitri.",
//       "Pada hari pertama, Senin (14 April 2025), diadakan halal bihalal sebagai bentuk silaturahmi setelah liburan.",
//       "Kegiatan ini diharapkan memberikan semangat baru bagi siswa dalam menjalani pembelajaran.",
//     ],
...
//     konten: [
//       "MI Al Maarif Ngadri berhasil meraih prestasi gemilang sebagai juara umum 2 pada ajang Porseni Kecamatan Binangun, 12 April 2025.",
//       "Ajang ini diikuti sekolah se-Kecamatan Binangun dan MI Al Maarif sukses mengumpulkan 32 piala dari berbagai kategori olahraga dan seni.",
//       "Keberhasilan ini berkat dukungan sekolah, guru, dan siswa yang tampil maksimal.",
//       "Prestasi ini semakin mengukuhkan MI Al Maarif Ngadri sebagai sekolah yang berkompeten dalam pengembangan potensi siswa.",
//     ],
