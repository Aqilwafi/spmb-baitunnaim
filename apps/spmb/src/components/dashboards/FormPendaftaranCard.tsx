...
import type { MasterLembaga } from "@bn/types";

interface LembagaListCardProps {
  data: MasterLembaga[];
}

export function FormPendaftaranCard({
  data,
}: LembagaListCardProps) {
